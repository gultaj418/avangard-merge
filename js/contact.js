...
const contactInput = document.querySelectorAll(".contactFormElementStyle");
const contactForm = document.querySelector(".contactUsInfo");

contactForm.addEventListener("submit", (e) => {
  for (i = 0; contactInput.length > i; i++) {
    if (contactInput[i].value === "") {
      contactInput[i].classList.add("alert");
    } else {
      contactInput[i].classList.remove("alert");
      console.log("submit");
      //   $(function () {
      //     // init the validator
